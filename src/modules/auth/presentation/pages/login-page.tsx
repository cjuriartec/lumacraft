      ...
      <div className="hidden lg:flex flex-col justify-between w-1/2 p-20 relative">
        <div className="relative z-10">
          <div className="flex items-center gap-3">
            ...
            <span className="text-primary text-sm font-bold uppercase tracking-[0.3em]">Lumacraft</span>
          </div>
        </div>
            ...
            <div className="pt-12 space-y-6">
              ...
              <div className="flex flex-col gap-4 text-center lg:text-left">
                ...
                <nav className="flex gap-6 justify-center lg:justify-start text-[11px] font-bold text-foreground opacity-40 uppercase tracking-widest">
                  <span className="hover:text-primary hover:opacity-100 cursor-pointer transition-colors">Legal</span>
                  <span className="hover:text-primary hover:opacity-100 cursor-pointer transition-colors">Privacidad</span>
                </nav>
              </div>
            </div>
          </div>
