  ...
  return (
    <TabsPrimitive.List
      ...
      className={cn(
        ...
        variant === "line" && "bg-transparent border-b border-border/10 justify-start w-full px-0 gap-6 rounded-none h-auto",
        className
      )}
      {...props}
    />
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        variant === "default" && "rounded-md data-[state=active]:bg-surface data-[state=active]:text-primary data-[state=active]:shadow-none",
        variant === "line" && "rounded-none border-b-2 border-transparent bg-transparent py-3 px-0 data-[state=active]:border-primary data-[state=active]:text-foreground data-[state=active]:bg-transparent transition-none",
        className
      )}
      {...props}
    />
